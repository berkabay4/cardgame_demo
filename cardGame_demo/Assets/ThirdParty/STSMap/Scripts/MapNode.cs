...
namespace Map
{
    public class MapNode : MonoBehaviour, IPointerEnterHandler, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
    {
        ...
        public void SetState(NodeStates state)
        {
            ...
            // Color32 -> Color cast + null-safe
            Color locked = Color.gray;
            Color visited = Color.white;
            if (owner != null)
            {
                locked  = (Color)owner.lockedColor;
                visited = (Color)owner.visitedColor;
            }
        ...
        public void OnPointerUp(PointerEventData data)
        {
            ...
            {
                // Sadece tracker’a bildir. Köprü (MapToSessionBridge) node tipine göre Combat/Rest/Shop açacak.
                if (MapPlayerTracker.Instance != null)
                    MapPlayerTracker.Instance.SelectNode(this);
                else
                    Debug.LogWarning("[MapNode] MapPlayerTracker.Instance is NULL");
            }
        }
        ...
        private void ApplyVisualFallback()
        {
            ...
            if (owner != null) locked = (Color)owner.lockedColor;
